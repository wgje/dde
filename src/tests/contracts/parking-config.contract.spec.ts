...
describe('PARKING_CONFIG contract', () => {
  ...
  it('focus scene tokens should match transparent-focus and zen defaults', () => {
    ...
    expect(PARKING_CONFIG.FOCUS_SCENE_ENTRY_BG_MS).toBe(0);
    expect(PARKING_CONFIG.FOCUS_SCENE_ENTRY_STAGE_MS).toBe(40);
    expect(PARKING_CONFIG.FOCUS_SCENE_ENTRY_RADAR_MS).toBe(90);
    expect(PARKING_CONFIG.FOCUS_SCENE_ENTRY_ENV_MS).toBe(140);
    expect(PARKING_CONFIG.FOCUS_SCENE_ENTRY_HUD_MS).toBe(120);
