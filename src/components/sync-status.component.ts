        ...
        @if (conflictCount() > 0) {
          <div class="space-y-1">
            <button 
              ...
              class="w-full flex items-center justify-between p-2 bg-amber-50 border border-amber-200 rounded-lg hover:bg-amber-100 transition-colors">
              <div class="flex items-center gap-2">
                <!-- 冲突图标 -->
                <div class="relative">
                ...
                <div class="text-left">
                  <span class="text-[11px] text-amber-700 font-medium">{{ conflictCount() }} 个数据冲突待解决</span>
                  <p class="text-[9px] text-amber-600">点击查看详情并选择保留版本</p>
                </div>
              </div>
