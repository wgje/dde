...
CREATE POLICY "owner select" ON "public"."projects" FOR SELECT USING ((( SELECT "auth"."uid"() AS "uid") = "owner_id"));
CREATE POLICY "owner update" ON "public"."projects" FOR UPDATE USING ((( SELECT "auth"."uid"() AS "uid") = "owner_id"));
