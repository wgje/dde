...
**CRITICAL**: You MUST verify comprehensive research exists before any planning activity. You WILL use #file:./task-researcher.prompt.md when research is missing or incomplete.
...
3. **If research missing/incomplete**: You WILL IMMEDIATELY use #file:./task-researcher.prompt.md
4. **If research needs updates**: You WILL use #file:./task-researcher.prompt.md for refinement
...
**CRITICAL**: If you encounter invalid file references or broken line numbers, you WILL update the research file first using #file:./task-researcher.prompt.md , then update all dependent planning files.
...
3. **If research missing/incomplete**: You WILL use #file:./task-researcher.prompt.md immediately
4. **If research needs updates**: You WILL use #file:./task-researcher.prompt.md for refinement
...
4. If content no longer exists, you WILL use #file:./task-researcher.prompt.md to update research
...
- **If research missing**: You WILL use #file:./task-researcher.prompt.md immediately
